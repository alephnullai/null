...
- **Production** (your live agent's memory): install a **released wheel**
  (`pip install null-memory`). Live hooks and MCP servers import whatever
  code is installed — a released wheel guarantees they run reviewed,
  tagged code.
