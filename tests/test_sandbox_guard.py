...
class TestLiveServerDetection:
    """_detect_live_server is plain pgrep pid-correlation; simulate the
    three outcomes by stubbing subprocess.run — never spawn pgrep here."""
    ...
    def test_running_server_detected(self, monkeypatch):
        self._stub(monkeypatch, returncode=0, stdout="1657\n26521\n")
